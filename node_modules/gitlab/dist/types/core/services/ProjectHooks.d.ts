...
export declare class ProjectHooks extends BaseService {
    ...
    add(projectId: string | number, url: string, options?: BaseRequestOptions): Promise<object>;
    edit(projectId: string | number, hookId: number, url: string, options?: BaseRequestOptions): Promise<object>;
    remove(projectId: string | number, hookId: number, options?: Sudo): Promise<object>;
}
