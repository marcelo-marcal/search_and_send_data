...
export declare class Services extends BaseService {
    edit(projectId: string | number, serviceName: SupportedService, options?: BaseRequestOptions): Promise<object>;
    remove(projectId: string | number, serviceName: SupportedService, options?: Sudo): Promise<object>;
