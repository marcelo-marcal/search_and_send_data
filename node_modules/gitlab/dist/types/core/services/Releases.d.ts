...
export declare class Releases extends BaseService {
    ...
    edit(projectId: string | number, tagName: string, options?: BaseRequestOptions): Promise<object>;
    remove(projectId: string | number, tagName: string, options?: Sudo): Promise<object>;
