...
export declare class ProjectSnippets extends BaseService {
    ...
    create(projectId: string | number, title: string, fileName: string, code: string, visibility: SnippetVisibility, options?: BaseRequestOptions): Promise<object>;
    edit(projectId: string | number, snippetId: number, options?: BaseRequestOptions): Promise<object>;
    remove(projectId: string | number, snippetId: number, options?: Sudo): Promise<object>;
