...
export declare class Wikis extends BaseService {
    ...
    edit(projectId: string | number, slug: string, options?: BaseRequestOptions): Promise<object>;
    show(projectId: string | number, slug: string, options?: Sudo): Promise<import("../infrastructure").GetResponse>;
    remove(projectId: string | number, slug: string, options?: Sudo): Promise<object>;
}
