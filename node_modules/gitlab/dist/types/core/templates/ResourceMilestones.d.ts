...
export declare class ResourceMilestones extends BaseService {
    ...
    create(resourceId: string | number, title: string, options?: BaseRequestOptions): Promise<object>;
    edit(resourceId: string | number, milestoneId: number, options?: BaseRequestOptions): Promise<object>;
