...
export declare class ResourceCustomAttributes extends BaseService {
    ...
    set(resourceId: string | number, customAttributeId: number, value: string, options?: Sudo): Promise<object>;
    remove(resourceId: string | number, customAttributeId: number, options?: Sudo): Promise<object>;
